...
const DefaultControls: FC<DefaultControlsProps> = ({ className, pageSizes = DEFAULT_PAGE_SIZES, pageSizeLabelGenerator = DEFAULT_TEXT_GENERATOR, statusMessageGenerator = DEFAULT_STATUS_MESSAGE_GENERATOR }) =>
